  ...
  return (
    <div className="flex items-stretch justify-between h-[calc(100vh-72px)]  gap-4 p-16">
      ...
      <div className="w-full flex flex-col justify-center">
        <h1 className="font-inter text-5xl font-semibold mb-6">Imagine being a part of <span className="text-4xl block">someone success story</span></h1>
        ...
        <div className="flex gap-4 mt-6">
          <button className="text-white bg-primary px-8 py-3 rounded-xl hover:bg-primary/75 transition-all duration-300 cursor-pointer" id="cta-button">Join Our Story</button>
          <button className="text-white bg-white/5 filter-blur-xl border-2 border-white/25 px-8 py-3 rounded-xl hover:bg-white/0 transition-all duration-300 cursor-pointer" id="cta-button">Read My Story</button>
        </div>
      </div>
      {/* RIGHT */}
